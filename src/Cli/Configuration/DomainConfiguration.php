    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->end()
                ->scalarNode('provider')
                    ->info('Certificate provider to use (supported: '.implode(', ', RunCommand::PROVIDERS).')')
                    ->defaultValue('letsencrypt')
                    ->validate()
                        ->ifTrue(function ($item) {
                            return !isset(RunCommand::PROVIDERS[$item]);
                        })
                        ->thenInvalid('The certificate provider %s is not valid (supported: '.implode(', ', RunCommand::PROVIDERS).').')
                    ->end()
                ->end()
